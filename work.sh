...
module "ec2" {
  ...
  tag_name                  = "capjen"
  public_key                = var.public_key
  subnet_id                 =  module.vpc.private_subnets[0] #tolist(module.vpc.capstoneWithJenkins_public_subnets)[0]
  enable_public_ip_address  = true
  security_groups = [module.sg.aws_security_group_id]
}
...
module "sg" {
  source = "./modules/sg"
  vpc_id = module.vpc.vpc_id #module.vpc.capstoneWithJenkins_vpc_id
}
